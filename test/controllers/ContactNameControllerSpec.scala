...
class ContactNameControllerSpec (implicit val ec: ExecutionContext) extends SpecBase with MockitoSugar {
  ...
  "ContactName Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(ContactNamePage, TestValues.userAnswer).success.value
