...
class SecondContactHavePhoneControllerSpec (implicit val ec: ExecutionContext) extends SpecBase with MockitoSugar {
  ...
  lazy val secondContactHavePhoneRoute = routes.SecondContactHavePhoneController.onPageLoad().url
