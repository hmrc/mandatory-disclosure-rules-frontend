...
class MessageSpecDataSpec extends SpecBase {
  ...
  "MessageSpecDataSpec" - {
    ...
    "must deserialize MessageSpec" in {
      val json     = Json.parse("""{"messageRefId":"XDSG333333","messageTypeIndic":"MDR402", "mdrBodyCount":2, "reportType":"MultipleCorrectionsDeletions"}""")
      val expected = MessageSpecData("XDSG333333", MDR402, 2, MultipleCorrectionsDeletions)
