...
import models.{AffinityType, CheckMode, Mode, UserAnswers}
      ...
      form
        ...
        .fold(
          ...
          value =>
            ...
            } yield Redirect(navigator.nextPage(SecondContactEmailPage, AffinityType(request.userType), mode, updatedAnswers))
        )
  }
}
